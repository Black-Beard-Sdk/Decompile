...
namespace Bb.Sdk.Decompiler.IlParser
{
    ...
    public class StLocInlineInstruction : ILInstruction
    {


        public StLocInlineInstruction(ILVariable variable, int offset, OpCode opCode, UInt16 index) : base(offset, opCode)
        {
