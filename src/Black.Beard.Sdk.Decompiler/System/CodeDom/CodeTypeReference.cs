...
#endif
{
...
#endif
    {
        ...
        public CodeTypeReference() : base(0)
        {
        ...
        public CodeTypeReference(Type type) : base(0)
        {
            if (type == null)
            {
        ...
        public CodeTypeReference(string baseType, int rank) : base(0)
        {
            _baseType = null;
            ArrayRank = rank;
        ...
        public CodeTypeReference(CodeTypeReference arrayType, int rank) : base(arrayType.Location.Offset)
        {
            _baseType = null;
            ArrayRank = rank;
